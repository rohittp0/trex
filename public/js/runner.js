...
class Runner {
     ...
     */
    loadImages() {
        const imageSources = IS_HIDPI ? Runner.imageSources.HDPI :
    ...
    update() {
        ...
        if (this.activated) {
            ...
            const playAcheivementSound = this.distanceMeter.update(deltaTime,
    ...
    static updateCanvasScaling(canvas, opt_width, opt_height) {
        ...
        // Query the constious pixel ratios
...
DistanceMeter.prototype = {
    ...
    draw: function (digitPos, value, opt_highScore) {
        ...
        if (opt_highScore) {
            ...
            const highScoreX = this.x - (this.config.MAX_DISTANCE_UNITS * 2) *
